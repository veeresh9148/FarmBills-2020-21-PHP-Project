...
(1, 'Abhishek', 8169193101, 'Mars', 'KARNTAKA', 'RAICHUR', '1234567890', 2147483647, 'm8bf5+Y='),
...
(92, 'bhabalomkar421', 8828071232, '1', 'KARNATAKA', 'BELLARY *', '1', 1, 'yw==');
...
--
CREATE TABLE `marketregistration` (
  `market_id` int(255) NOT NULL,
  `market_name` varchar(255) NOT NULL,
  `market_phone` bigint(10) NOT NULL,
  `market_address` text NOT NULL,
  `market_state` varchar(50) NOT NULL,
  `market_district` varchar(50) NOT NULL,
  `market_pan` varchar(10) NOT NULL,
  `market_bank` int(16) NOT NULL,
  `market_password` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
--
...
CREATE TABLE `bankregistration` (
  ...
  `bank_phone` bigint(10) NOT NULL,
  `bank_address` text NOT NULL,
  `bank_state` varchar(50) NOT NULL,
  `bank_district` varchar(50) NOT NULL,
  `bank_pan` varchar(10) NOT NULL,
  `bank_password` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
--
...
--
-- Indexes for table `marketregistration`
--
ALTER TABLE `marketregistration`
  ADD UNIQUE KEY `market_id` (`market_id`);
--
-- Indexes for table `marketregistration`
--
ALTER TABLE `bankregistration`
...
--
ALTER TABLE `bankregistration`
  MODIFY `bank_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
--
-- AUTO_INCREMENT for table `marketregistration`
--

ALTER TABLE `marketregistration`
  MODIFY `market_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
