...
<head>
    ...
    <title>market Registration Portal</title>
...
<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header" style="background-color:#292b2c"><h4 style="font-style:bold;color:goldenrod">Market Registration<h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="MarketRegister.php" method="post">
...
if (isset($_POST['register'])) {
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        ...
        $query = "insert into marketregistration (market_name,market_phone,
                market_address, market_state, market_district,market_pan,market_password)values ('$name','$phonenumber','$address',
                '$state','$district','$pan','$password')";

        $run_register_query = mysqli_query($con, $query);
        echo "<script> alert('SucessFully Registerd') </script>";
        echo "<script>window.open('MarketLogin.php','_self') </script>";
