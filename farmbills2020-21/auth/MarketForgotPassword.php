...
<body>
    ...
    <div class="box">
        <form action="MarketForgotPassword.php" method="post">
...
if (isset($_POST['register'])) {
    ...
    $query = "select * from marketregistration where market_phone = '$phonenumber' and market_pan = '$pan'";
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        if ($count_rows != 0) {
            $update_query = "update marketregistration set market_password = '$password' 
                                 where market_phone = '$phonenumber' and market_pan = '$pan' ";
