...
<body>
    ...
    <div class="box">
        <form action="BankForgotPassword.php" method="post">
...
if (isset($_POST['register'])) {
    ...
    $query = "select * from bankregistration where bank_phone = '$phonenumber' and bank_pan = '$pan'";
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        if ($count_rows != 0) {
            $update_query = "update bankregistration set bank_password = '$password' 
                                 where bank_phone = '$phonenumber' and bank_pan = '$pan' ";
