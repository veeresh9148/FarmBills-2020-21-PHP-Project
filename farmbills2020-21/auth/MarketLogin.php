...
<meta charset="UTF-8">
	...
	<title>Market Login portal</title>
				...
				<div class="col-md-8">
					<div class="card " >
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="MarketLogin.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									...
									<br>
									<label id="account" class="text-left"><a id='link' href="MarketRegister.php"><b style="color:black"> Create New Account</b></a></label>
								</div>
							</form>
						</div>
					</div>
...
if (isset($_POST['login'])) {
	...
	$query = "select * from marketregistration where market_phone = '$phonenumber' and market_password = '$password'";
	...
	echo "<script>window.open('../MarketPortal/mhome.php','_self')</script>";
}
}
