				...
				<div class="col-md-8">
					<div class="card " >
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="bankLogin.php" method="post">
								...
								<br>
								<div class="col-md-6 offset-md-4">
									<label id="forgotPassword"  class="text-left"><a id='link' style="" href="BankForgotPassword.php"><b style="color:black ;text-align:left"> Forgot your password </b></a></label>
									<br>
									<label id="account" class="text-left"><a id='link' href="BankRegister.php"><b style="color:black"> Create New Account</b></a></label>
								</div>
							</form>
						</div>
					</div>
...
if (isset($_POST['login'])) {
	...
	$query = "select * from bankregistration where bank_phone = '$phonenumber' and bank_password = '$password'";
	$run_query = mysqli_query($con, $query);
	$count_rows = mysqli_num_rows($run_query);
	if ($count_rows == 0) {
		echo "<script>alert('Please Enter Valid Details');</script>";
		echo "<script>window.open('bankLogin.php','_self')</script>";
	}else{
	...
	echo "<script>window.open('../bankportal/bankHomepage.php','_self')</script>";
}
}
