...
<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header" style="background-color:#292b2c"><h4 style="font-style:bold;color:goldenrod">Bank Registration<h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="BankRegister.php" method="post">
								<div class="form-group row">
									<label for="full_name" class="col-md-4 col-form-label text-md-right"><i class="fas fa-user mr-2"></i><b>Bank Name</b></label>
									<div class="col-md-6">
...
if (isset($_POST['register'])) {
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        ...
        $query = "insert into bankregistration (bank_name,bank_phone,
                bank_address, bank_state, bank_district,bank_pan,bank_password)values ('$name','$phonenumber','$address',
                '$state','$district','$pan','$password')";
