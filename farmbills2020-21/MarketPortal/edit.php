<?php
  ...
  if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "select * from msp where id=".$id;
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php
                    ...
                    <div class="form-group">
                      <label for="">Market_Name</label>
                      <input type="text" class="form-control" name="Market_Name"  placeholder="" value="<?php echo $row['market_name']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="">Current_Date</label>
                      <input type="date" class="form-control" name="Current_Date"  placeholder="" value="<?php echo $row['date']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="">Current_Time</label>
                      <input type="time" class="form-control" name="Current_Time"  placeholder="" value="<?php echo $row['time']; ?>">
                    </div>

                    <div class="form-group">
                      <label for="image">Choose Image</label>
                      <div class="col-md-4">
                        <img src="<?php echo $row['msp_image'] ?>" width="100">
                        <input type="file" class="form-control" name="msp_image" value="">
                      </div>
