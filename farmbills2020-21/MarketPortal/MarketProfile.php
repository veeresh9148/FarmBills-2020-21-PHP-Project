...
// session_start();
 ...
 $sql = "select * from marketregistration where market_phone = '$sessphonenumber' ";
 $run_query = mysqli_query($con, $sql);
 while ($row = mysqli_fetch_array($run_query)) {
     $market_name = $row['market_name'];
     $market_phone = $row['market_phone'];
     $market_address = $row['market_address'];
     $market_pan = $row['market_pan'];
...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <a class="float-left" href="bhome.php">
                <img src="fb1.jpg" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
            </a>
        </div>
        <button class="navbar-toggler" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"><i class='fas fa-bars p-1' style='font-size:30px; color: green;margin-top:2px;'></i></span>
        </button>
        <a class="float-left" href="bhome.php">
            <img src="fb1.jpg" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
        </a>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="input-group mb-1 ml-2 searchbox">
                ...
                <form action="SearchResult.php" method="get" enctype="multipart/form-data">
                    <input type="text" class="form-control " id="inlineFormInputGroup" name="search" placeholder="Search for states,districts or apmcname " style="width:500px;">
                </form>
            </div>
            <i class='far fa-user-circle' style='font-size:25px; icon-size:25px; color: green; mergin-top:2px'>
           <?php
           getmarketname();
            ?></i>
            <div class="list-group moblists">
                <?php
                if (isset($_SESSION['phonenumber'])) {
                    echo "<a href='MarketProfile.php' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Profile</a>";
                        echo "<a href= 'create.php' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Add MSP</a>";
                        echo "<a href='index.php' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>View MSP</a>";
                        ...
                        echo "<a href='#' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Meeting</a>";
                        echo "<a href='#' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Storage</a>";
                        echo "<a href='#' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Technologies</a>";
                        echo "<a href='MarketLogout.php' class='list-group-item list-group-item-action ' style='background-color:#292b2c;text-align:center;color:goldenrod'>Logout</a>";
                    } else {
                        echo "<a href='../auth/MarketLoginLogin.php' class='dropdown-item ' style='padding-right:-20px;'>Login</a>";
                    }
                ?>
            </div>
        </div>
    ...
    <div class="container-fluid" style="max-width:520px">
        <form action="mhome.php" method="post">
            <table align="center">
                <tr colspan=2>
                    <h1> MARKETS'S PROFILE</h1>
                </tr>
                <tr align="center">
                    <td><label><b>Name :</b></label></td>
                    <td>
                         <textarea rows="2" column="10" disabled> <?php echo $market_name ?> </textarea>
                    <br></td>
                </tr>
                <tr align="center">
                    <td><label><b>Phone Number :</b></label></td>
                    <td><textarea rows="2" column="10" disabled> <?php echo $market_phone ?> </textarea><br></td>
                </tr>
                <tr align="center">
                    <td><label><b>Address :</b></label></td>
                    <td><textarea rows="3" column="56" disabled> <?php echo $market_address ?> </textarea><br></td>
                </tr>

                <tr align="center">
                    <td><label><b>State :</b></label></td>
                    <td><textarea rows="3" column="56" disabled> <?php echo $market_state ?> </textarea><br></td>
                </tr>
                <tr align="center">
                    <td><label><b>District :</b></label></td>
                    <td><textarea rows="3" column="56" disabled> <?php echo $market_district ?> </textarea><br></td>
                </tr>

                <tr align="center">
                    <td><label><b>Pan Number :</b></label></td>
                    <td><textarea rows="2" column="10" disabled> <?php echo $market_pan ?> </textarea><br></td>
                </tr>
               <tr>
                <td colspan=2><input type="submit" name="" value="Home"></td>
                </tr>
            </table>
