...
<center><h3>Minimum Support Price</h3></center>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">ADD MSP</div>
              <div class="card-body">
                <form class="" action="add.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                      <label for="">Market_Name</label>
                      <input type="text" class="form-control" name="market_name"  placeholder="" required>
                    </div>
                    <div class="form-group">
                      <label for="">Current_Date</label>
                      <input type="date" class="form-control" name="Current_Date"  placeholder="" required>
                    </div>
                    <div class="form-group">
                      <label for="">Current_Time</label>
                      <input type="time" class="form-control" name="Current_Time"  placeholder="" required>
                    </div>
                    <div class="form-group">
                      <label for="">Choose MSP Image</label>
