...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container">
        <a class="navbar-brand" href="index.php">Storage Edit</a>
              ...
              <div class="card-body">
                <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="district" placeholder="Enter District" value="<?php echo $row['district']; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="adress">Address</label>
                      <input type="text" class="form-control" name="adress" placeholder="Enter Address" value="<?php echo $row['adress']; ?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="storage">Storage</label>
                       <input type="text" class="form-control" name="storage" placeholder="Enter Storage" value="<?php echo $row['storage']; ?>" readonly>
                    </div>
                    <div class="form-group">
