              ...
              <div class="card-body">
                <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="status" placeholder="Enter Status" value="<?php echo $row['status']; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="storage">Storage</label>
                       <input type="text" class="form-control" name="storage" placeholder="Enter Storage" value="<?php echo $row['storage']; ?>">
                    </div>
                    <div class="form-group">
