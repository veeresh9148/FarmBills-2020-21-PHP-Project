     ...
     <nav class="navbar navbar-expand-xl ">
          ...
          <div class=" flex-row-reverse left ">
               ...
               <a class="float-left" href="#">
                    <img src="fb.jpg" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
               </a>
          </div>
          ...
          <a class="float-left" href="farmerHomepage.php">
               <img src="fb.jpg" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
          </a>
          ...
          <div class=" flex-row-reverse right ">
               ...
               <div class="dropdown p-2 settings ">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                         <?php
                         if (isset($_SESSION['phonenumber'])) {
                              echo "<a href='farmerHomepage.php' class='dropdown-item' style='padding-right:-20px;'>Home</a>";
                                   ...
                                   <div class='row'>
                                        ...
                                        <div class='col-md-6 blackgoldie'>
                                             ...
                                             <div class='row' style='padding:7px; margin-bottom:15px;' >
                                                 ...
                                                 <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 aligncenter'> <a href='deleteproduct.php?id=$prod_id' class='btn btn-warning border-secondary' style='color:black'><b>delete Product</b></a></div>
                                             </div>
                                        </div>         
                                   </div>
                              </div>
          ...
          <div class="container">
               ...
               <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                         <p><u><a href="https://www.farmbills.com/">farm bills</a></u> </p>
                         <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">farm bills</a></p>
                    </div>
                    </hr>
               </div>
          </div>
