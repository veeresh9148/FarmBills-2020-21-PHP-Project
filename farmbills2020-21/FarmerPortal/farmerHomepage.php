      ...
      <body>
           ...
           <nav class="navbar navbar-expand-xl ">
                ...
                <div class=" flex-row-reverse left ">
                    ...
                    <a href="CartPage.php"> <i class="fa" style=" color:green ;font-size:20px;margin-top:-20px;margin-bottom:20px;">&#61562;</i></a> -->
                     ...
                     <a class="float-left" href="#">
                          <img src="fb1.jpg" class="float-left mr-5 ml-0 " alt="Logo" style="height:65px;">
                     </a>
                </div>
                ...
                <a class="float-left" href="farmerHomepage.php">
                     <img src="fb1.jpg" class="float-left mr-2 moblogo" alt="Logo" style="height:65px;">
                </a>
                <center><b> Welcome to Farmer Portal</b></center>
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                               <?php
                                   if (isset($_SESSION['phonenumber'])) {
                                        ...
                                        echo "<a href='../MarketPortal/activity.php' class='dropdown-item' style='padding-right:-20px;'>View MSP</a>";
                                        echo "<a href='Transactions.php' class='dropdown-item' style='padding-right:-20px;'>Orders</a>";
                                        echo "<a href='../BuyerPortal2/agreement/index1.php' class='dropdown-item' style='padding-right:-20px;'>Agreements</a>";
                                        echo "<a href='complaint/index.php' class='dropdown-item' style='padding-right:-20px;'>Complaints</a>";
                                        echo "<a href='storage/index.php' class='dropdown-item' style='padding-right:-20px;'>Storage</a>";
                                        echo "<a href='../bank/customer_login_action.php' class='dropdown-item' style='padding-right:-20px;'>Bank</a>";
                ...
                <div class="container">
                     ...
                     <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                               <p><u><a href="https://www.farmbills.com/">Farmbills</a></p>
                               <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">farmbills</a></p>
                          </div>
                          </hr>
                     </div>
                </div>
