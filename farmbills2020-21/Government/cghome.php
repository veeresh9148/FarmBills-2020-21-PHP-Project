...
<head>
    ...
    <title>Central Government Homepage</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <a class="float-left" href="cghome.php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
           ...
           <h3> welcome to central government <h3>
        </div>
            ...
            <div class="dropdown p-2 settings ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    if (isset($_SESSION['username'])) {
                        echo "<a href='#' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>States</a>";
                        echo "<a href= '#' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>APMC Markets</a>";
                        echo "<a href='#' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Banks</a>";
                        echo "<a href='#' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Articles</a>";
                        echo "<a href='GovernmentLogout.php' class='list-group-item list-group-item-action ' style='background-color:#292b2c;text-align:center;color:goldenrod'>Logout</a>";
                    } else {
                        echo "<a href='../Government/GovernmentLoginLogin.php' class='dropdown-item ' style='padding-right:-20px;'>Login</a>";
                    }
                    ?>
                </div>
            </div>
