...
<meta charset="UTF-8">
	...
	<title>Central Government Login portal</title>
				...
				<div class="col-md-8">
					<div class="card " >
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="GovernmentLogin.php" method="post">

								<div class="form-group row">
									<label for="username" class="col-md-4 col-form-label text-md-right"><i class="fas fa-phone-alt mr-2"></i><b>User Name</b></label>
									<div class="col-md-6">
										<input type="text" id="username" class="form-control border border-dark" name="username" placeholder="user name" required>
									</div>
								</div>
...
if (isset($_POST['login'])) {
	...
	if ($count_rows == 0) {
		...
		echo "<script>window.open('GovernmentLogin.php','_self')</script>";
	}else{
	...
	echo "<script>window.open('../Government/cghome.php','_self')</script>";
}
}
