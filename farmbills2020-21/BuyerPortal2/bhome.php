        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="list-group moblists">
                ...
                if (isset($_SESSION['phonenumber'])) {
                    ...
                    echo "<a href='../FarmerPortal/agreement/index.php' class='dropdown-item' style='padding-right:-20px;'>Agreement</a>";
        ...
        <div class=" flex-row-reverse right ">
            ...
            <div class="dropdown p-2 settings ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <?php
                    if (isset($_SESSION['phonenumber'])) {
                        echo "<a href='../BuyerPortal/BuyerProfile.php' class='dropdown-item  ' style='padding-right:-20px;'>Profile</a>";
                        echo "<a href='Transaction.php' class='dropdown-item ' style='padding-right:-20px;'>Transactions</a>";
                        echo "<a href='agreement/index.php' class='dropdown-item' style='padding-right:-20px;'>agreement</a>";
                         echo "<a href='../bank/customer_login_action.php' class='dropdown-item' style='padding-right:-20px;'>Bank</a>";
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.farmbills.com/">FarmBills 2020-21</a></u> for farmers ang traders</p>
