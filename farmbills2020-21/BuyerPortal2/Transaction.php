        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="list-group moblists">
                ...
                if (isset($_SESSION['phonenumber'])) {
                    ...
                    echo "<a href='#' class='dropdown-item' style='padding-right:-20px;'>Agreement</a>";
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.agrocraft.com/">Farmbills2020-21</a></u> is a advancement agriculture marketting</p>
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">farmbills 2020-21</a></p>
                </div>
                </hr>
            </div>
        </div>
