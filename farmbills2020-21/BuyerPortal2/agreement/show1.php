...
<html>
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container">
          <a class="navbar-brand" href="index.php">Agreement</a>
              ...
              <div class="row">
                ...
                <div class="col-md">
                    ...
                    <h5 class="form-control"><i class="fa fa-envelope">
                      ...
                      <a class="btn btn-outline-danger" href="../../FarmerPortal/farmerHomepage.php"><i class="fa fa-sign-out-alt"></i><span>Back</span></a>
