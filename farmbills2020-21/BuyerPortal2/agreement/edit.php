              ...
              <div class="card-body">
                <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="date"  placeholder="Enter Name" value="<?php echo $row['date']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="status" placeholder="" value="<?php echo $row['status']; ?>" >
                    </div>
                    <div class="form-group">
