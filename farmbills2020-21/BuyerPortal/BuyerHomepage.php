...
<body>
	...
	<div class="headerdown">
		<div id="show">
			<div class="sel1 sel">
				<button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">CROPS</i>
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item">
					<img class="images1" src="../portal_files/same1.jpg" height="400px" width="1000px" alt="...">
				</div>
	...
	<div class="instaid">
		...
		<div class="gmailid">
			<a href="#" style="color:black;">agrocraft6@gmail.com</a></div>

	</div>


	<div class="copy">
		<h5 style="text-align:center; padding-top:40px;margin-left:650px">Copyright &copy; 2022 by www.AgroCraft.com</h5>
	</div>
